...
public class AppGUI extends JFrame implements ActionListener {
    private final JLabel studentIdLabel, firstNameLabel, lastNameLabel, programLabel, phoneLabel, dobLabel;
    private final JTextField studentIdField, firstNameField, lastNameField, programField, phoneField, dobField;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == addButton) {
            ...
            String sql = "INSERT INTO sdata VALUES('" + studentIdField.getText() + "', '"
                    + firstNameField.getText() + "', '" + lastNameField.getText() + "', '" + programField.getText()
                    + "', '" + phoneField.getText() + "', '" + dobField.getText() + "')";
            try {
            ...
            String[] options = {"First Name", "Last Name", "Program"};
            ...
            switch (choice) {
                ...
                case 2 -> sql = "SELECT * FROM sdata ORDER BY Program";
                default -> {
                }
            }
            try {
            ...
            String[] options = {"Student ID", "Last Name", "Program"};
            ...
            try {
                ...
                if (rs.next()) {
                    String[] options = {"First Name", "Last Name", "program", "Phone", "Date of Birth"};
